...
const NewCard = ({ color = "red", desc, main, icon }) => {
    return (
        <div className={`inline group my-10 bg-${color}-300 p-5 py-6 rounded-3xl flex flex-col justify-between hover:cursor-pointer`}>
